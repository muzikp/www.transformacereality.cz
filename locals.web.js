...
module.exports = {    
    ...
    poslani: {
        ...
        short: "Již více než 20 let s naším zkušeným týmem proměňujeme zajímavé nemovitosti a vdechujeme jim nový život. Každý projekt začíná pečlivým výběrem lokality a objektu, důkladným posouzením jeho stavu a zamyšlením nad jeho budoucím využitím. Naší vizí je vytvářet proměny, které budou dobře sloužit nejen současným, ale i budoucím generacím."
    },
    sluzby: {
        full: [
            {
                header: "Nákup a prodej nemovitostí",
                text: "Poptáváte vhodné místo k bydlení? Hledáte prostory pro své podnikání?"
            },
            {
                header: "Rekonstrukce",
                text: "Připravujeme a zajišťujeme rekonstrukce a výstavby včetně veškeré dokumentace."
            },
            {
                header: "Realitní poradenství",
                text: "Potřebujete konzultovat svoje realitní plány? V realitách se pohybujeme mnoho let. Málo co nás překvapí. Rádi poradíme i Vám."
            },
            {
                header: "Financování",
    ...
    projekty: [
        ...
        },
        {
            ...
            popis: {
                ...
                studio: {
                    label: "Projekční kancelář",
                    text: [
                        "Myška, s.r.o.",
                        "Jiřího náměstí 17/28",
                        "Poděbrady, 290 01"
                    ]
                }
            },
        ...
        },
        {
            ...
            popis: {
                ...
                studio: {
                    label: "Autorský tým",
                    text: [
                        `Dipl. Ing. Eleonora Kubani, <a class="inherit" href="www.kubani.cz" target="_blank">Kubanidesign</a>`,
                        `<a class="inherit" href="www.ebarch.cz" target="_blank">Ing. arch. Eva Kubíčková</a>`                        
                    ]
                }
            },
            preview: {
